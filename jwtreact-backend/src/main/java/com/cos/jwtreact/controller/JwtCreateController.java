package com.cos.jwtreact.controller;
...
import com.cos.jwtreact.config.jwt.JwtProperties;
import com.cos.jwtreact.config.oauth.provider.GoogleUser;
import com.cos.jwtreact.config.oauth.provider.OAuthUserInfo;
